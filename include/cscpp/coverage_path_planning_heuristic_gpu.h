...
public:
    ...
    bool isConnectionConditionSatisfied(geometry_msgs::Pose pose,geometry_msgs::Pose pose2);
    ...
    geometry_msgs::Pose findBestPitch(Sensors &rSensor, geometry_msgs::Pose pose, pcl::PointCloud<pcl::PointXYZ>& globalCloud);
    geometry_msgs::Pose findBestOri(Sensors &rSensor, geometry_msgs::Pose &pose, pcl::PointCloud<pcl::PointXYZ>& globalCloud);
