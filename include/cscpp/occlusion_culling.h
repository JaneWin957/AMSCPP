...
public:
    ...
    double getAccuracyCloud(pcl::PointCloud<pcl::PointXYZ> pointCloud, geometry_msgs::Pose cameraPose, pcl::PointCloud<pcl::PointXYZ>& accuracyCloud, double threshhold);
    ...
    void visualizeFOV(geometry_msgs::Pose location, int index);
